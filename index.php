...
<body>
	<div id="wrapper">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<h1 style="border-bottom: 1px solid #ccc; padding-bottom: 20px"><img src="img/favico.png" alt="---"> Angular: Site Scaffolding & Bootstrap v0.2</h1>
					...
					<p>This is only the introduction page. The installation file for this scaffolding setup has not yet configured since the framework stack is still in active development. To start working with the stack anyway, please rename this file into something different and rename the _index.php file to index.php. </p>
